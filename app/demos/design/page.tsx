    ...
    <>
      ...
      <div className={styles.mainContainer}>
        <div className={styles.page}>
          ...
          <p className={styles.subtitle}>כמה פעמים מצאתם את  עצמכם במטבח, מתלבטים וחושבים: <strong>אם רק היה מי שינחה אותי עכשיו.</strong></p>
          ...
          <p className={styles.ourGoal1}>המטרה שלנו היא להפוך את חוויית הבישול לחברתית ותומכת, לעודד שיתופיות, למידה הדדית וגיוון תפריט המשפחה</p>
        </div>
        <div className={styles.firstBanner}>
          <div className={styles.right}>
            ...
            <div className={styles.rightDown}>
              <div className={styles.circle}>חוויה, הדדיות, גיוון <br /> יחד, בזמן אמת</div>
            </div>
          </div>
          <div className={styles.left}>
            <div className={styles.leftUp}>
              <div className = {styles.ellipse}>לבשל. <br />לשתף. <br />ללמוד.</div>
            </div>
        ...
        <div className={styles.finalBanner}>
          <div className = {styles.finalBannerTexts}>
